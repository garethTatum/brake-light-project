...
def write(x, img):
    ...
    cv2.rectangle(img, [*c1.tolist(), *c2.tolist()] ,color, 1)
    ...
    # print(*c3.tolist())
    cv2.rectangle(img, [*c1.tolist(), c3[0].tolist(), c3[1].tolist()] ,color, -1)
...
if __name__ == '__main__':
    ...
    video_out = cv2.VideoWriter("/content/drive/MyDrive/AI-Project/Video-Out/video-out.mov", cv2.VideoWriter_fourcc(*'mp4v'), 30, (1280, 720), True)
    video_out_brake = cv2.VideoWriter("/content/drive/MyDrive/AI-Project/Brake-Out/brake-out.mov", cv2.VideoWriter_fourcc(*'mp4v'), 30, (1280, 720), True)
